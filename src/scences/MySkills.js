            ...
            <div className='md:flex md:justify-center md:gap-16 mt-32'>
                ...
                >
                    <p className='font-playfair font-semibold text-4xl mb-5'>
                        MY <span className='text-red'>SKILL</span>
                    </p>
                ...
                <div className='mt-16 md:mt-0'>
                    ...
                    >
                        <img
                            alt='skills'
                            className='z-10'
                            src='https://i.postimg.cc/CMH995HG/skills-image.png'
                        />
                    </div>}
                </div>
            </div>
            ...
            <div className='md:flex md:justify-between mt-16 gap-32'>
                ...
                >
                    <div className='relative h-32'>
                        ...
                        <div className='w-1/2 md:w-3/4 h-32 bg-slate-200 absolute right-0 top-0 z-[-1' />
                    </div>
                    <p className='mt-5'>
